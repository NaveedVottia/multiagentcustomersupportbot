...
const schedulingPrompt = `「修理予約エージェント」です。修理予約の受付とスケジュール管理を行います。
...
async function updateSchedulingPrompt() {
  try {
