...
async function createCustomerIdentificationPrompt() {
  try {
    console.log("🔧 Creating customer-identification prompt in Langfuse...");
    ...
    console.log("✅ Customer identification prompt created successfully!");
    console.log("Prompt ID:", prompt.id);
    console.log("Prompt version:", prompt.version);
    
  } catch (error) {
    console.error("❌ Error creating customer identification prompt:", error);
    if (error.response) {
...
createCustomerIdentificationPrompt();
